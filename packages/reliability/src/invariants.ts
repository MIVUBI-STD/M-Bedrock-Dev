...
export const BUILT_IN_INVARIANTS: readonly ReliabilityInvariant[] = [
  ...
  {
    id: "multiplayer.assignment-consistency",
    title: "Player assignment and arena membership agree",
    description: "A player assigned to an arena must appear in exactly that arena's active membership.",
    domain: "multiplayer",
    severity: "critical",
    lanes: ["generative", "runtime"],
    tags: ["multiplayer", "assignment", "session"],
    source: "built-in",
  },
  {
    id: "multiplayer.disconnect-resets-progress",
    title: "Disconnect clears active session progress",
    description: "Disconnecting from an active session clears progress while preserving only the permitted arena assignment policy.",
    domain: "multiplayer",
    severity: "critical",
    lanes: ["generative", "runtime"],
    tags: ["disconnect", "reconnect", "progress", "session"],
    source: "built-in",
  },
  {
    id: "multiplayer.cutscene-owned-by-arena-session",
    title: "Cutscene state is owned by the arena session",
    description: "An arena cutscene must be active only while that arena has a valid starting session.",
    domain: "multiplayer",
    severity: "critical",
    lanes: ["generative", "runtime"],
    tags: ["cutscene", "concurrency", "arena"],
    source: "built-in",
  },
  {
    id: "multiplayer.playing-requires-active-session",
    title: "Playing state requires an active connected session",
    description: "A player cannot remain in playing state without a connected arena assignment.",
    domain: "multiplayer",
    severity: "critical",
    lanes: ["generative", "runtime"],
    tags: ["playing", "disconnect", "assignment"],
    source: "built-in",
  },
  {
